...
<body>
	...
	<div class="container">
		<div class="header1">
			<img src="src/imgs/sun.png" alt="">
			<h1>About Shamsina</h1>
		</div>
	</div>
	</div>
	<div class="container about1">
		<div class="main">
			<p>Shamsina designs, manufactures and delivers affordable, locally-made solar water heaters for all Egyptians, from energy poor communities to energy-conscious consumers. Our local production process helps revive industry and strengthens local know-how. Through a cross-subsidy model, Shamsina makes reliable solar water heaters widely accessible, reaching every corner of the country and especially those who struggle most. Shamsina’s grid-free model transforms the way we secure energy by decentralizing access and freeing users from monthly bills. Every step of our process is eco-friendly and socially-centered.</p>
			<div class="brd-btm"></div>
		</div>
		<div class="about row">
			<div class="col-lg-6">
				<div class="pic"><img src="src/imgs/eye.png" alt="eye"></div>
				<h5>our vision</h5>
				<p>Shamsina envisions a world where clean energy is accessible to all.</p>
			</div>
			<div class="col-lg-6">
				<div class="pic1"><img src="src/imgs/sun2.png" alt="sun2"></div>
				<h5>our mission</h5>
				<p>Shamsina creates affordable solar technologies for all Egyptians.</p>
			</div>
		</div>
	</div>
