...
<body>
	<nav class="navbar nav2 navbar-expand-lg navbar-light bg-light fixed-top trans">
		<div class="container">
			<a class="navbar-brand" href="index.php">
				<img src="src/imgs/logo.png" alt="" loading="lazy">
			</a>
	...
	<div class="container">
		<main>
			<video autoplay muted loop id="myVideo">
				<source src="src/videos/Shamsina.mp4" type="video/mp4">
			</video>
